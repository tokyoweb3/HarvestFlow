...
declare const endpoints: {
    ...
    getSummary: () => Promise<import("@paima/sdk/mw-core").FailedResult | import("./types").GetSummaryResponse>;
    getRWAData: (contractAddress: string, tokenId: string) => Promise<import("@paima/sdk/mw-core").FailedResult | import("./types").GetRWADataResponse>;
    exportLogs: () => string;
