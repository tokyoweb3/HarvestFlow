  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1300px] w-full mx-auto min-h-full flex flex-col justify-end desktop:pb-[60px] desktop:pt-20 gap-32 px-4 desktop:px-0">
        <div className="flex flex-col desktop:flex-row desktop:justify-between desktop:items-end gap-16 desktop:gap-10">
          <div className="w-full desktop:w-full flex-1">
            <div className="flex flex-col gap-3">
              <h2 className="text-heading3 desktop:text-heading3_34 font-medium uppercase">
                RWA 001
              </h2>
              <h1 className="text-heading3 desktop:text-heading1Smaller font-medium uppercase whitespace-pre-line">
